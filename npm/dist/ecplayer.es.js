...
function vt({
  ...
  const [L, H] = m(!1), [j, P] = m(0), [M, D] = m(0), [k, S] = m(C || 100), [ae, me] = m(!1), [V, ee] = m(!1), [se, ie] = m(!1), [ce, de] = m([]), [R, Q] = m(!1), [Y, oe] = m({
    bass: z.bass || 0,
    mid: z.mid || 0,
    treble: z.treble || 0
  }), [ue, te] = m(1), [G, w] = m(0), p = b(null), A = b(null), K = b(null), fe = b(null), W = b(null), re = b(null), X = b(null), N = b(null), T = b(null), Z = b(null);
  $(() => {
    const t = Z.current;
    if (!t) return;
  ...
  const r = x || [
    ...
    { freq: 1e4 },
    { freq: 12500 }
  ], d = b(r.map(() => 0)), g = b(r.map(() => 0)), B = b(r.map(() => 0)), _ = b(!1), J = b(typeof v == "string" ? v : "purple"), h = typeof v == "string" ? ge[v] || ge.purple : typeof v == "object" ? v : ge.purple, E = O === "dark", ke = typeof y == "object" && Object.keys(y).length === 0;
  $(() => {
    ...
    _.current = L, N.current && (cancelAnimationFrame(N.current), N.current = null), L ? (A.current || Ce(), Ne()) : he();
  }, [L]);
  const Ce = () => {
  ...
  const Ue = ke || F ? void 0 : E ? "#6060606a" : "#ffffffab", Oe = ke || F ? void 0 : h.bg;
  return /* @__PURE__ */ e("div", { ref: Z, className: "ecp-vp-wrapper", style: { backgroundColor: Ue }, children: /* @__PURE__ */ c("div", { className: "ecp-vp-bg", style: { background: Oe }, children: [
    /* @__PURE__ */ c("div", { className: "ecp-vp-vu-outer", children: [
      /* @__PURE__ */ e("div", { className: `ecp-vp-vu-bg${E ? " ecp-vp-vu-bg--dark" : " ecp-vp-vu-bg--light"}${R && F ? " ecp-vp-vu-bg--dimmed" : ""}${ke ? " ecp-vp-vu-bg--no-margin" : ""}`, children: /* @__PURE__ */ e("div", { className: "ecp-vp-vu-bars", ref: T }) }),
    ...
    y.seekbar && /* @__PURE__ */ e("div", { className: "ecp-vp-seekbar", children: /* @__PURE__ */ c("div", { className: "ecp-vp-seekbar-row", children: [
      /* @__PURE__ */ e("span", { className: `ecp-vp-time${E ? " ecp-vp-time--dark" : " ecp-vp-time--light"}`, children: qe(j) }),
      /* @__PURE__ */ e(
        "input",
        {
          type: "range",
      ...
      /* @__PURE__ */ e("span", { className: `ecp-vp-time ecp-vp-time--right${E ? " ecp-vp-time--dark" : " ecp-vp-time--light"}`, children: qe(M) })
    ] }) }),
...
function bt({
  ...
  const [x, F] = m(!1), [I, z] = m(0), [L, H] = m(0), [j, P] = m(!1), [M, D] = m(80), [k, S] = m(1), [ae, me] = m([]), [V, ee] = m(null), [se, ie] = m(!1), [ce, de] = m({ bass: y.bass || 0, mid: y.mid || 0, treble: y.treble || 0 }), R = b(null), Q = b(null), Y = b(null), oe = b(null), ue = b(null), te = b(null), G = () => {
    const r = [];
  ...
  $(() => {
    ...
    const d = () => z(r.currentTime), g = () => {
      ...
      var h, E;
      return ee(`Audio error: ${((E = (h = J.target) == null ? void 0 : h.error) == null ? void 0 : E.message) || "Failed to load audio"}`);
    };
  ...
  const w = () => {
    ...
    const d = r.currentTarget.getBoundingClientRect(), B = (r.clientX - d.left) / d.width * L;
...
function gt({ audio: s, thumbnail: l, gradient: u = ["#cd7eff", "#fe59f6"], background: v = "#1f273a", autoPlay: C = !1 }) {
  const [f, y] = m(!1), [, O] = m(0), x = b(null), [F, I] = m(0), [z, L] = m(0), [H, j] = m(0);
  $(() => {
    const k = x.current;
    if (!k) return;
...
function wt({
  ...
  const [z, L] = m(!1), [H, j] = m(0), [P, M] = m(0), [D, k] = m(v || 100), [S, ae] = m(!1), [me, V] = m(!1), [ee, se] = m(!1), [ie, ce] = m([]), [de, R] = m(!1), [Q, Y] = m({ bass: I.bass || 0, mid: I.mid || 0, treble: I.treble || 0 }), [oe, ue] = m(1), [te, G] = m(0), w = b(null), p = b(null), A = b(null), K = b(null), fe = b(null), W = b(null), re = b(null), X = b(null), N = b(null), T = b(null), Z = b(0), r = b(0), d = b(0), g = b(0), B = b(0), _ = b(0), J = b(!1), h = y === "dark" || ee, E = typeof f == "object" && Object.keys(f).length === 0;
  $(() => {
    const n = p.current;
    if (!n) return;
    ...
    if (s) {
      ...
      j(0), L(!1), Z.current = 0, r.current = 0, d.current = 0, g.current = 0, B.current = 0, _.current = 0, he();
    }
  }, [s]), $(() => {
    ...
    J.current = z, N.current && (cancelAnimationFrame(N.current), N.current = null), z && u ? (A.current || ke(), we()) : !z && u && Ce();
  }, [z, u]), $(() => {
  ...
  const ke = () => {
    ...
    !w.current || !s || (z ? w.current.pause() : (A.current && A.current.state === "suspended" && A.current.resume(), w.current.play().catch((n) => console.error("Play failed:", n))));
  }, ve = () => {
    w.current && (w.current.pause(), w.current.currentTime = 0, L(!1), j(0), Z.current = 0, r.current = 0, d.current = 0, g.current = 0, he());
  }, xe = (n) => {
  ...
  return /* @__PURE__ */ e(
    "div",
    {
      ...
      style: { backgroundColor: E || O ? void 0 : h ? "#49494937" : "white" },
      children: /* @__PURE__ */ c(
        "div",
        {
          className: `ecp-video-inner${ee ? " ecp-video-inner--fullscreen" : ""}${E || O ? "" : " ecp-video-inner--padded"}`,
          style: { background: E || O ? void 0 : h ? "#1a1a1ab0" : "#f5f5f5" },
          children: [
...
function Nt() {
  const [s, l] = m(null), [u, v] = m("No track loaded"), [C, f] = m("purple"), [y, O] = m(!1), [x, F] = m(!1), [I, z] = m("light"), L = b(null);
  return /* @__PURE__ */ e("div", { className: "ecp-page-wrapper", style: { backgroundColor: I === "dark" ? "#222" : "white" }, children: /* @__PURE__ */ c("div", { className: "ecp-demo-container", children: [
    ...
    /* @__PURE__ */ c("div", { className: "ecp-container-glass", children: [
      ...
      /* @__PURE__ */ c("div", { className: "ecp-demo-actions", children: [
        /* @__PURE__ */ e("input", { type: "file", ref: L, onChange: (P) => {
          var D;
